        ...
        >
            <div className="flex size-full max-w-lg flex-row items-stretch justify-between gap-10">
                ...
                <div className="flex flex-col justify-center gap-2">
                    <Circle ref={div1Ref} className="size-[53px]">
                        <div className="flex flex-col items-center justify-center gap-1">
                            <IBCoursesIcon className="fill-blue-500 size-4" />
                            <p className="text-[10px] text-blue-500 font-semibold">
                                HL/SL
                            </p>
                        </div>
                    </Circle>
                    <Circle ref={div2Ref} className="size-[53px]">
                        <div className="flex flex-col items-center justify-center gap-1">
                            <CASIcon className="fill-pink-500 size-4" />
                            <p className="text-[10px] text-pink-500 font-semibold">
                                CAS
                            </p>
                        </div>
                    </Circle>
                    <Circle ref={div3Ref} className="size-[53px]">
                        <div className="flex flex-col items-center justify-center gap-1">
                            <EEIcon className="fill-green-500 size-4" />
                            <p className="text-[10px] text-green-500 font-semibold">
                                EE
                            </p>
                        </div>
                    </Circle>
                    <Circle ref={div4Ref} className="size-[53px]">
                        <div className="flex flex-col items-center justify-center gap-1">
                            <IAIcon className="fill-orange-500 size-4" />
