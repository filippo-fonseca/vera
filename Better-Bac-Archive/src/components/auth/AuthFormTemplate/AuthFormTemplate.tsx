...
const AuthFormTemplate = (props: IAuthFormTemplate) => {
                    ...
                    <div className="text-center flex flex-col gap-2">
                        ...
                        <CustomDiv>
                            ...
                            <CustomText className="text-gray-600">
                                The students have missed you. Let's log you in.
                            </CustomText>
                        </CustomDiv>
                    </div>
                </div>
                <div className="flex flex-col w-full gap-6 mt-8">
                    <div className="w-full">
                        ...
                        <CustomTextInput
                            type="email"
                            id="email-input"
                            description="Remember to use your school email address."
                            placeholder="you@yourschool.edu"
                            onChange={e =>
                                authStore.setTempAuthEmail(e.target.value)
                            }
                        />
                    </div>
                    <div className="w-full">
                        ...
                        <CustomTextInput
                            ...
                            placeholder="•••••••••••••"
                            onChange={e =>
                                authStore.setTempAuthPassword(e.target.value)
                            }
                            onEnterPress={e => {
                                if (!props.disabled) {
                                    props.handleLogin(e);
...
export default observer(AuthFormTemplate);
