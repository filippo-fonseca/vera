...
const StudentAuth: React.FC = () => {
    ...
    const email = authStore.tempAuthEmail;
    const password = authStore.tempAuthPassword;
        ...
        try {
            ...
            if (userDoc.exists()) {
                ...
                if (!userData?.isEducator) {
                    ...
                    authStore.setErrMsg(
                        "Sorry, you're not registered as a student in our records. If you're an educator or school admin, click below."
                    );
                }
            } else {
...
export default observer(StudentAuth);
